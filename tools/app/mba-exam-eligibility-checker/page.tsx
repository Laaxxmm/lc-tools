...
export const metadata: Metadata = {
  openGraph: {
    ...
    siteName: 'Learn Crew',
    locale: 'en_IN',
    images: [{ url: `/tools/og/mba-exam-eligibility-checker.png`, width: 1200, height: 630, alt: tool.title }],
  },
  twitter: { card: 'summary_large_image', title: tool.title,
    description: tool.description, images: [`/tools/og/mba-exam-eligibility-checker.png`] },
  title: tool.title,
  description: tool.description,
